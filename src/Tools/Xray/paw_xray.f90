...
!
!     ...1.........2.........3.........4.........5.........6.........7.........8
      SUBROUTINE RIXS_OUTPUTONEKPT(NFIL)  ! MARK: RIXS_OUTPUTONEKPT
!     **************************************************************************
!     ** OUTPUT ONEKPT RIXS AMPLITUDES                                        **
!     ** REQUIRES RIXS INITIALIZED, SELECTED, AND ONEKPT SPECTRUM CALCULATED  **
!     **************************************************************************
      ...
      IF(.NOT.TINITIALIZE) THEN
        CALL ERROR$MSG('RIXS NOT INITIALIZED')
        CALL ERROR$STOP('RIXS_OUTPUTONEKPT')
      END IF
      IF(.NOT.SELECTED) THEN
        CALL ERROR$MSG('SAFEGUARD FUNCTION:')
        CALL ERROR$MSG('RIXS SPECTRUM NOT SELECTED')
        CALL ERROR$STOP('RIXS_OUTPUTONEKPT')
      END IF
      ! CHECK IF SPECTRUM IS AT ONE KPT, IF NOT, RETURN
      IF(THIS%TKPTSHIFT) RETURN
      CALL MPE$QUERY('~',NTASKS,THISTASK)
      CALL KSMAP$RTASK(RTASK)
      ...
      DEALLOCATE(TINVARR)
      RETURN
      END SUBROUTINE RIXS_OUTPUTONEKPT
!
!     ...1.........2.........3.........4.........5.........6.........7.........8
