...
!     **************************************************************************
      ...
      WRITE(NFIL,FMT='(7A10)')'IKPT','ISPIN','XK1','XK2','XK3','WKPT','TINV'
      DO IKPT=1,THIS%NKPT
        DO ISPIN=1,THIS%NSPIN
          WRITE(NFIL,FMT='(2I10,4F10.6,L10)')IKPT,ISPIN,THIS%XK(:,IKPT), &
...
!     **************************************************************************
      USE RIXS_MODULE, ONLY: TINITIALIZE,SELECTED,THIS,NSPEC,EMIN,EMAX
      USE SHARED_DATA_MODULE, ONLY: ABSORB
      IMPLICIT NONE
...
! TODO: IMPLEMENT CATCH THAT SKIPS COMPLETELY IF NO ONEKPT SPECTRA ARE NEEDED
...
! CONTINUE HERE: SAVE AMPLITUDE BY ADDING UP, MULTIPLY WITH H MATRIX
                  CALL RIXS$UNSELECT
                ENDDO ! END ISPEC
              ENDDO ! END IELL
! CONTINUE HERE
