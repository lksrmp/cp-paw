...
! ERROR: SHOULD THIS BE RADIAL$INTEGRATE AND THEN RADIAL$VALUE AT RBOX?
!        RBOX IS NOT AVAILABLE AND WOULD REQUIRE REWRITING THE OVERLAP FILE
!        THIS MAKES ALL ALREADY CREATED ONE INVALID
        ...
        CALL RADIAL$INTEGRAL(GID,NR,WORK,R2CORE(ISIM))
...
! ERROR: SHOULD THIS BE RADIAL$INTEGRATE AND THEN RADIAL$VALUE AT WHAT VALUE?
!        VALUE IS NOT AVAILABLE AND WOULD REQUIRE REWRITING THE OVERLAP FILE
!        THIS MAKES ALL ALREADY CREATED ONE INVALID
