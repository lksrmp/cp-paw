...
!     **                                                                      **
!     **************************************************************************
      USE XCNTL_MODULE, ONLY: LL_CNTL,ADET,BASISWGHT,NORMALIZE
      USE LINKEDLIST_MODULE
      IMPLICIT NONE
...
!     **************************************************************************
      USE XCNTL_MODULE, ONLY: TOVERLAP,ADET,BASISWGHT,NORMALIZE
      IMPLICIT NONE
...
!     **************************************************************************
      ...
      ! TODO: CHECK IF IT OPERATES CORRECTLY
      ! NORMALIZE OVERLAPS
      IF(TNORMALIZE) ADET(:,:)=ADET(:,:)/SQRT(ADETSUM)
      DO IKPT=1,NKPT
        DO ISPIN=1,NSPIN
          CALL OVERLAP$SELECT(IKPT,ISPIN)
