...
!
!     ...1.........2.........3.........4.........5.........6.........7.........8
      SUBROUTINE XAS$FILEHANDLER(ISPEC,FLAG)  !MARK: XAS$FILEHANDLER
!     **************************************************************************
...
!     **************************************************************************
      ...
      ENDIF
      IF(FLAG.EQ.'O') THEN
        CALL FILEHANDLER$SETFILE('XASOUT',.FALSE., &
     &                           TRIM(ADJUSTL(SPECTRUMARR(ISPEC)%FILE)))
      ELSE IF(FLAG.EQ.'C') THEN
        CALL FILEHANDLER$CLOSE('XASOUT')
      ELSE
